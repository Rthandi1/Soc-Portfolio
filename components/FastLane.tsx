...
const FastLane: React.FC = () => {
  const links = [
    { label: 'Resume', url: 'resume\\Rayman Thandi Resume-Cybersecurity.pdf', download: "Rayman-Thandi-Resume.pdf", icon: (
    ...
    { label: 'LinkedIn', url: 'https://www.linkedin.com/in/rayman-thandi-847b46196', icon: (
      <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
    )},
    { label: 'GitHub', url: 'https://github.com/Rthandi1', icon: (
    ...
    { label: 'Email', url: 'mailto:thandi.rayman@gmail.com', icon: (
    ...
    <div className="bg-white border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-wrap items-center justify-center sm:justify-between py-4 gap-4">
          <div className="text-sm font-bold text-slate-400 uppercase tracking-widest hidden lg:block">Recruiter Fast Lane:</div>
